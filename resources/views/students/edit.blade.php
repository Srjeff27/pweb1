                ...
                <div class="p-8 sm:p-10">
                    <form action="{{ route('students.update', $student) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="shrink-0">
                                @if($student->photo)
                                    <img class="h-24 w-24 object-cover rounded-2xl border-4 border-slate-50 shadow-sm" src="{{ asset('storage/' . $student->photo) }}" alt="Foto {{ $student->name }}" />
                                @else
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" :value="old('name', $student->name)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="nim" name="nim" type="text" class="mt-1 block w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" :value="old('nim', $student->nim)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" name="email" type="email" class="mt-1 block w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" :value="old('email', $student->email)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm" :value="old('phone', $student->phone)" required />
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address" rows="3" class="mt-1 block w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm">{{ old('address', $student->address) }}</textarea>
